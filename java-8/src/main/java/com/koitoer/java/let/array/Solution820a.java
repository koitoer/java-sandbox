...
public class Solution820a {

    @Test
    public void test() {

        Assertions.assertThat(new Solution820a().minimumLengthEncoding(new String[] { "aabbcbb", "bbc" })).isEqualTo(12);

        Assertions.assertThat(new Solution820a().minimumLengthEncoding(new String[] { "time", "me", "bell" })).isEqualTo(10);
        //System.out.println();
        Assertions.assertThat(new Solution820a().minimumLengthEncoding(new String[] { "me", "time", "bell", "time", "me" })).isEqualTo(10);

        Assertions.assertThat(new Solution820a().minimumLengthEncoding(
